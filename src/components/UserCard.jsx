        ...
        <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="px-6 py-4 font-medium text-gray-900"># de identificación</th>
              <th scope="col" className="px-6 py-4 font-medium text-gray-900">Telefono</th>
              ...
              <th scope="col" className="px-6 py-4 font-medium text-gray-900">Programas</th>
